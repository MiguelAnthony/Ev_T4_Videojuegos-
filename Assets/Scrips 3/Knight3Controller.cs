...
public class Knight3Controller : MonoBehaviour
{
    ...
    private const int ANIMATION_QUIETO=0;
      ...
      //  public GameObject kunai;
        ...
        public Puntaje3Controller PuntajeController;
       public Text Textvidas;
        ...
        private void OnCollisionEnter2D(Collision2D other)
        {
            ...
            if (other.gameObject.tag == "alien1"&&acct==0)
            {
                if (cubrirse == 0)
                {
            ...
            if (other.gameObject.tag == "alien2"&&acct==0)
            {
                if (cubrirse == 0)
                {
                    PuntajeController.AddPoints(45);
                    vidas=vidas-25;
                    Destroy(other.gameObject);
                    Debug.Log("Vidas"+vidas);
                    Textvidas.text = "Vidas: "+vidas;
            ...
            if (other.gameObject.tag == "alien3"&&acct==0)
            {
                if (cubrirse == 0)
                {
                    PuntajeController.AddPoints(60);
                    vidas=vidas-35;
                    Destroy(other.gameObject);
                    Debug.Log("Vidas"+vidas);
                    Textvidas.text = "Vidas: "+vidas;
            ...
            if (other.gameObject.tag == "alien1"&&acct==1)
            {
                PuntajeController.AddPoints(25);
               // Destroy(other.gameObject);
            }
            if (other.gameObject.tag == "alien2"&&acct==1)
            {
                PuntajeController.AddPoints(45);
               // Destroy(other.gameObject);
            }
            if (other.gameObject.tag == "alien3"&&acct==1)
            {
                PuntajeController.AddPoints(60);
                // Destroy(other.gameObject);
            } 
        ...
        {
            SceneManager.LoadScene("Mapa_Zombie");
        }
}
